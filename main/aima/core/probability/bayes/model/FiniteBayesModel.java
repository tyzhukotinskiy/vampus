package main.aima.core.probability.bayes.model;

import main.aima.core.probability.CategoricalDistribution;
import main.aima.core.probability.FiniteProbabilityModel;
import main.aima.core.probability.RandomVariable;
import main.aima.core.probability.bayes.BayesInference;
import main.aima.core.probability.bayes.BayesianNetwork;
import main.aima.core.probability.bayes.exact.EnumerationAsk;
import main.aima.core.probability.proposition.AssignmentProposition;
import main.aima.core.probability.proposition.ConjunctiveProposition;
import main.aima.core.probability.proposition.Proposition;
import main.aima.core.probability.util.ProbUtil;
import main.aima.core.probability.util.ProbabilityTable;
...
public class FiniteBayesModel implements FiniteProbabilityModel {
    ...
    public boolean isValid() {
        ...
        return Math.abs(1 - prior(representation
                .toArray(new Proposition[representation.size()]))) <= DEFAULT_ROUNDING_THRESHOLD;
    }
