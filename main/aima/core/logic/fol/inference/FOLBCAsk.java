...
import main.aima.core.logic.fol.Unifier;
import main.aima.core.logic.fol.inference.proof.AbstractProofStep;
import main.aima.core.logic.fol.inference.proof.Proof;
import main.aima.core.logic.fol.inference.proof.ProofStep;
...
import main.aima.core.logic.fol.parsing.ast.AtomicSentence;
import main.aima.core.logic.fol.parsing.ast.Sentence;
...
public class FOLBCAsk implements InferenceProcedure {
     ...
     * @param query goals, a list of conjuncts forming a query
     ...
     * generator FOL-BC-OR(KB, goal, θ) yields a substitution
     *
     * @param kb    The knowleadge base
     * @param goal  The goals at the or node to be achieved
