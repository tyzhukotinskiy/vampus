package main.aima.core.learning.reinforcement.example;

import main.aima.core.agent.Agent;
import main.aima.core.agent.impl.AbstractEnvironment;
import main.aima.core.environment.cellworld.Cell;
import main.aima.core.environment.cellworld.CellWorldAction;
...
public class CellWorldEnvironment extends AbstractEnvironment<CellWorldPercept, CellWorldAction> {
     ...
     * Constructor.
     *
     * @param startingCell the cell that agent(s) are to start from at the beginning of
     ...
     * Execute N trials.
     *
     * @param n the number of trials to act.
     */
