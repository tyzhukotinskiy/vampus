...
import main.aima.core.util.math.permute.CombinationGenerator;
...
public class MinimalConsistentDet {
     ...
     * function Minimal-Consistent-Det(E, A) returns a set of attributes
     *
     * @param e  inputs: E, a set of examples
     * @param a      A, a set of attributes, of size n
     * @return
     */
     ...
     * function Consistent-Det?(A, E) returns a truth value
     *
     * @param attributes inputs: A, a set of attributes
     * @param examples        E, a set of examples
     * @return
     */
