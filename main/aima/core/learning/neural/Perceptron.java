...
public class Perceptron implements FunctionApproximator {
     ...
     *
     * @param innds          a set of training examples for constructing the layer of this
     *                       perceptron.
     * @param numberofEpochs the number of training epochs to be used.
     */
     ...
     *
     * @param nnds the neural network data set to be tested on.
